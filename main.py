import pandas as pd
from data_fetch import crawl_report_page
...
test_df = crawl_report_page("https://www.gunviolencearchive.org/mass-shooting")

michigan_rows = test_df[test_df["State"] == "Michigan"]

plot_cases(michigan_rows)